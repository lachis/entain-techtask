...
type SportsClient interface {
	...
	ListEvents(ctx context.Context, in *ListEventRequest, opts ...grpc.CallOption) (*ListEventResponse, error)
}
...
func (c *sportsClient) ListEvents(ctx context.Context, in *ListEventRequest, opts ...grpc.CallOption) (*ListEventResponse, error) {
...
type SportsServer interface {
	// ListEvents will return a collection of all events.
	ListEvents(context.Context, *ListEventRequest) (*ListEventResponse, error)
}
...
func (UnimplementedSportsServer) ListEvents(context.Context, *ListEventRequest) (*ListEventResponse, error) {
...
func _Sports_ListEvents_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(SportsServer).ListEvents(ctx, req.(*ListEventRequest))
	}
